...
void main() {
  ...
  Map<String, dynamic> dynamicFractalConfigs = {}; // Todo: Add dynamic fractal configs later
  GreatWall greatWallProtocolWithDynamicFractal = GreatWall(
    treeArity: -1,
    treeDepth: 3, // Todo: Add dynamic fractal tree depth later depending on the user's choice
    timeLockPuzzleParam: 10,
    tacitKnowledge: DynamicFractalTacitKnowledge(configs: dynamicFractalConfigs),
  );
  ...
  greatWallProtocolWithDynamicFractal.sa0 = Sa0(Formosa.fromRandomWords(wordCount: 6, formosaTheme: FormosaTheme.bip39)); // Todo: replace the Sa0 with the actual Sa0 object

  // Start the protocol derivation process.
  greatWallProtocolWithDynamicFractal.startDerivation();
  greatWallProtocolWithDynamicFractal.makeTacitDerivation(choice: "x: 0.123456789, y: 0.987654321");
  greatWallProtocolWithDynamicFractal.makeTacitDerivation(choice: "x: 0.123411565, y: 0.98444534321");
  greatWallProtocolWithDynamicFractal.makeTacitDerivation(choice: "x: 0.1234519, y: 0.447654321");
