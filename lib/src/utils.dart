...
class DerivationPath<N extends Choice> extends Iterable<N> {
  ...
  @override
  bool operator ==(Object other) => //Todo: needs a look
...
class Choice {
  final Uint8List choice;
  Choice(this.choice);

  @override
  bool operator ==(Object other) =>
      other is Choice && const ListEquality().equals(choice, other.choice);

  @override
  int get hashCode => const ListEquality().hash(choice);

  Uint8List get value => choice;
}
